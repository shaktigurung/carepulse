      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField 
            ...
            name="address"
            label="Address"
            placeholder="14th Street, Sydney"
          />
          <CustomFormField 
            fieldType={FormFieldType.INPUT}
            control={form.control}
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          ...
          <CustomFormField 
            ...
            placeholder="ex: ibuprofen 200mg, levothyrozine 50mcg"
            disabled={false}
          />
        </div>
        <div className="flex flex-col gap-6 xl:flex-row">
          ...
          <CustomFormField 
            ...
            placeholder="ex: Asthma dignosis in childhood"
            disabled={false}
          />
        </div>
        ...
        <CustomFormField 
          ...
          label="I consent to disclosure fo information"
        />
        <CustomFormField 
          fieldType={FormFieldType.CHECKBOX}
          control={form.control}
